...
public class StringUtils2 {
    ...
    public static String toOracleSearchLike(String searchText) {
        ...
        for (String str : arrSpPat) {
            if (!StringUtils2.isNullOrEmpty(searchText)) {
     ...
     *             <code>org.apache.commons.lang.StringUtils.isBlank(s)</code>
     */
    @Deprecated
    ...
    /**
     * @deprecated <code>isNullOrEmpty(s, true)</code> replaced by
     *             <code>org.apache.commons.lang.StringUtils.isBlank(s)</code> and
     *             <code>isNullOrEmpty(s, false)</code> replaced by
     *             <code>org.apache.commons.lang.StringUtils.isEmpty(s)</code>
     */
    @Deprecated
    ...
    public static List<Long> getIds(String input) {
        List<Long> result = new ArrayList<>();
        if (input != null) {
            String[] parts = input.split(",");
            for (String part : parts) {
                try {
                    result.add((long) Integer.parseInt(part));
                } catch (NumberFormatException e) {
                }
            }
        }
